    ...
    <>
      ...
      >
        ...
        <button
          ...
          style={{ backgroundColor: '#0f172a', boxShadow: '0 0 0 3px rgba(255,255,255,0.15), 0 8px 32px rgba(0,0,0,0.5)' }}
          title="اتصال هاتفي"
          id="floating-call-btn"
        >
          <Phone className="w-7 h-7" style={{ transform: "scaleX(-1)" }} />
        </button>
      </div>
      ...
      >
        ...
        <button
          ...
          className="w-16 h-16 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none cursor-pointer"
          style={{ backgroundColor: '#10b981', boxShadow: '0 0 0 3px rgba(16,185,129,0.3), 0 8px 32px rgba(16,185,129,0.4)' }}
          title="تواصل واتساب"
          id="floating-whatsapp-btn"
        >
          <MessageCircle className="w-7 h-7" style={{ transform: "scaleX(-1)" }} />
        </button>
      </div>
    </>
  );
